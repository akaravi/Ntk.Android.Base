...
interface IHyperShopContentService {
    ...
    Observable<ErrorException<HyperShopContentModel>> GetAll(@Path(value = "cpath", encoded = true) String cpath, @HeaderMap Map<String, String> headers, @Body FilterDataModel dataModel);
